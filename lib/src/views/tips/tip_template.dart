...
class TipSmallHeader extends StatelessWidget {
  TipSmallHeader(this.text);
...
class TipParagraph extends StatelessWidget {
  TipParagraph(this.text);
...
class TipTemplate extends StatelessWidget {
  TipTemplate({
    @required this.image,
    @required this.body,
  });
            ...
            SliverList(
              delegate: SliverChildListDelegate(
                AnimationConfiguration.toStaggeredList(
                  ...
                  children: body
                      .map((w) => Padding(
                            padding: const EdgeInsets.all(tipPadding),
                            child: w,
                          ))
                      .toList(),
                ),
